...
* 9:15-10:15 - Split sessions: 
    - *Practitioners* - Generating ballots that model voter behavior [notebook](https://github.com/mggg/Training_Materials/blob/main/notebooks/practitioners/Prac_2_knobs_to_turn.ipynb)
    - *Technical* - Data sources, acquisition, and prep  [notebook](https://github.com/mggg/Training_Materials/blob/main/notebooks/technical/Tech_2_data_sources_acquisition_prep.ipynb)
* 10:30-11:15 - Sharing session: Features and characteristics of your local jurisdictions 
* 11:30 - 12:30 - Split sessions: 
    - *Practitioners* - Understanding data, running elections [notebook](https://github.com/mggg/Training_Materials/blob/main/notebooks/practitioners/Prac_3_cvrs_elections.ipynb)
    - *Technical* - Running elections, single and parallel [batching code](https://github.com/mggg/Training_Materials/tree/main/notebooks/technical/Tech_3_batching)
* 2-3:30 - Place-specific exercise, Part 1 [expectations](https://github.com/mggg/Training_Materials/blob/main/place_specific_expectations.txt)
* 3:45-4:30 - Data visualizations with VoteKit [notebook](https://github.com/mggg/Training_Materials/blob/main/notebooks/joint/Joint_1_Viz.ipynb)
